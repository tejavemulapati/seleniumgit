...
public class GoogleTest {
	...
	public void googleLogoTest2() {
	boolean b =	driver.findElement(By.cssSelector("body:nth-child(2) div.L99Ugb:nth-child(2) div.o3j99.LLD4me.yr19Zb.LS8OJ:nth-child(2) div.k1zIA.rSk4se:nth-child(2) > img.lnXdpd:nth-child(2)")).isDisplayed();
	System.out.println("The value is"+b);
	}
